...
# aim: This file carry an data modelling proccess of the Brown Treecreeper data to a restricted format 
# Input: A csv file that contains all the instance about the Brown Treecreeper. 
...
#read the input file
test1 = read.csv('test2.csv',header = TRUE)
